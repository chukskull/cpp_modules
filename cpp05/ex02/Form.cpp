...
/*   Updated: 2022/11/14 17:26:51 by snagat           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form(const int grade, std::string name, const int execute) :name(name), _signed(UNSIGNED),c_grade(grade), c_excute(execute)
{
	GradeTooHighException	a;
	GradeTooLowException	b;
...
const char*	Form::ExecuteTooLowException:: what() const throw()
{
	return "executeTooLowException";
}

const char*	Form::is_signed:: what() const throw()
{
